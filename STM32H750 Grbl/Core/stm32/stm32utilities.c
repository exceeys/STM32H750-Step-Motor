...
void timing_init()
{
#ifdef STM32H7	   // STM32H750에서 TIM2 클럭입력은 SystemCoreClock / 2 이므로
	uTICKS_PER_MICROSECOND = (SystemCoreClock / 1000000) / 2;
	fTICKS_PER_MINUTE = (SystemCoreClock * 60.0f) / 2.0f;
#else
